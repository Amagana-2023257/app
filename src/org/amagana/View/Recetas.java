...
public class Recetas extends javax.swing.JFrame {
    ...
    private static Recetas instancia;

    public static synchronized Recetas getInstancia() {
        if (instancia == null) {
            instancia = new Recetas();
        }
        return instancia;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Gestiona tus recetas.");

        jButton10.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jButton10.setText("Pre-Productos →");
