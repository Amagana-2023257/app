...
public class Login extends javax.swing.JFrame {
    ...
    public static synchronized Login getInstancia() {
        if (instancia == null) {
            instancia = new Login();
        }
        return instancia;
    ...
    private void initComponents() {
        ...
        jPasswordField1.setToolTipText("Ingresa tu contraseña para acceder");

        jTextField1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jTextField1.setToolTipText("Ingresa tu usuario para acceder");
